  ...
  categories: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          questionText:
            "Who starts the fire that leads to the fire drill in Season 5?",
          options: ["Michael", "Dwight", "Ryan", "Kevin"],
          correctAnswerIndex: 1,
        },
        {
          questionText:
            "What branch does Jim transfer to before returning to Scranton?",
        ...
        {
          questionText:
            "What is the name of the cat Angela hides in the ceiling?",
        ...
        {
          questionText:
            "What game do the employees play during 'Office Olympics'?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          questionText:
            "What is the name of Ted’s first girlfriend shown in the series?",
